...
public class PeakFinderGCFX
{
	...
	private double[][][] isothermalDataArray = null;
	...
	public void run()
	{
		...
		try {
			...
			// Create the scene
			Scene scene = new Scene(root, 50 * rem, 40 * rem);
	...
	private void launchPeakFinderDialog()
	{
		...
		Scene peakFinderDialogScene = new Scene(peakFinderPane);
    ...
    public void setIsothermalData (double[][][] isothermalDataArray)
    {
    	this.isothermalDataArray = isothermalDataArray;
    }
