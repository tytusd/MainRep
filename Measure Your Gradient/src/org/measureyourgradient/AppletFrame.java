...
public class AppletFrame extends JFrame
{
	...
	protected MeasureYourGradientApplet myApplet;
	...
	{
		AppletFrame myFrame = new AppletFrame("Measure Your Gradient"); // create frame with title
	    myFrame.setResizable(true);
	    
	    myFrame.myApplet = new MeasureYourGradientApplet(); // define applet of interest
