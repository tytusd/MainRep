...
public class WastePropertiesDialog extends JDialog implements ActionListener, KeyListener, FocusListener
{
	 ...
	 * @param owner
	 */
	public WastePropertiesDialog(Frame owner) 
	{
		super(owner);
		initialize();
