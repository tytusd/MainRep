...
public class AutosamplerPropertiesDialog extends JDialog implements ActionListener, KeyListener, FocusListener
{
	...
	public String m_strName = "Default autosampler";
	 ...
	 * @param owner
	 */
	public AutosamplerPropertiesDialog(Frame owner) 
	{
		super(owner);
		initialize();
	...
	private void initialize() 
	{
		...
		this.setTitle("Autosampler Properties");
	}
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			jLabel1 = new JLabel();
			jLabel1.setBounds(new Rectangle(12, 44, 75, 16));
			...
			jContentPane.add(getJbtnChooseColor(), null);
			jContentPane.add(getJColorPanel(), null);
		}
		return jContentPane;
	}
	...
	private JButton getJbtnOk() {
		if (jbtnOk == null) {
			jbtnOk = new JButton();
			jbtnOk.setBounds(new Rectangle(8, 80, 125, 31));
	...
	private JButton getJbtnCancel() {
		if (jbtnCancel == null) {
			...
			jbtnCancel.setBounds(new Rectangle(144, 80, 125, 31));
	...
	private JButton getJbtnChooseColor() {
		if (jbtnChooseColor == null) {
			...
			jbtnChooseColor.setBounds(new Rectangle(144, 40, 125, 25));
	...
	private JPanel getJColorPanel() {
		if (jColorPanel == null) {
			...
			jColorPanel.setBounds(new Rectangle(92, 44, 41, 17));
