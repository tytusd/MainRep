...
public class GraphControl extends GLCanvas implements GLEventListener, MouseListener, MouseMotionListener
{
	...
	public GraphControl() 
	{
		super(new DefaultGLCaps(GLProfile.get(GLProfile.GL2)));
	...
	void drawSelectionCursor()
	{
		...
		if (leftCursorPos > m_rectGraph.left && leftCursorPos < m_rectGraph.right)
		{
			gl2.glBegin(GL2.GL_QUADS);
				gl2.glColor4f(0.0f,0.0f,0.0f,0.1f);
				gl2.glVertex2d(m_rectGraph.left, m_rectGraph.top);
				gl2.glVertex2d((int)leftCursorPos, m_rectGraph.top);
				gl2.glVertex2d((int)leftCursorPos, m_rectGraph.bottom);
				gl2.glVertex2d(m_rectGraph.left, m_rectGraph.bottom);
			gl2.glEnd();
			gl2.glBegin(GL2.GL_LINES);
				gl2.glColor4f((float)51/(float)255,(float)51/(float)255,(float)51/(float)255, 1.0f);
				gl2.glVertex2d((int)leftCursorPos, m_rectGraph.top);
				gl2.glVertex2d((int)leftCursorPos, m_rectGraph.bottom);
			gl2.glEnd();
		}
		...
		if (rightCursorPos > m_rectGraph.left && rightCursorPos < m_rectGraph.right)
		{
			gl2.glBegin(GL2.GL_QUADS);
				gl2.glColor4f(0.0f,0.0f,0.0f,0.1f);
				gl2.glVertex2d(m_rectGraph.right, m_rectGraph.top);
				gl2.glVertex2d((int)rightCursorPos, m_rectGraph.top);
				gl2.glVertex2d((int)rightCursorPos, m_rectGraph.bottom);
				gl2.glVertex2d(m_rectGraph.right, m_rectGraph.bottom);
			gl2.glEnd();
			gl2.glBegin(GL.GL_LINES);
				gl2.glColor4f((float)51/(float)255,(float)51/(float)255,(float)51/(float)255, 1.0f);
				gl2.glVertex2d((int)rightCursorPos, m_rectGraph.top);
			...
			(leftCursorPos >= m_rectGraph.right && rightCursorPos >= m_rectGraph.right))
		{
			gl2.glBegin(GL2.GL_QUADS);
				gl2.glColor4f(0.0f,0.0f,0.0f,0.1f);
				gl2.glVertex2d(m_rectGraph.right, m_rectGraph.top);
				gl2.glVertex2d(m_rectGraph.left + 1, m_rectGraph.top);
				gl2.glVertex2d(m_rectGraph.left + 1, m_rectGraph.bottom);
				gl2.glVertex2d(m_rectGraph.right, m_rectGraph.bottom);
			gl2.glEnd();
		}
        ...
        printGL(m_rendererYAxisDivision, (int)(leftCursorPos - 2), (int)(m_rectGraph.bottom + 3), JUSTIFY_LEFT, 90, strLeftCursorPos);
        printGL(m_rendererYAxisDivision, (int)(rightCursorPos + metricsXAxisDivision.getHeight() + 3), (int)(m_rectGraph.bottom + 3), JUSTIFY_LEFT, 90, strRightCursorPos);
		gl2.glPopMatrix();
	}
