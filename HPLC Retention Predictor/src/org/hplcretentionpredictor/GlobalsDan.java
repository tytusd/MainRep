...
public class GlobalsDan
{
	...
	// For a 2.1 x 150 mm column at 400 uL/min_JH_2015.03.04
	...
	public static String[] StationaryPhaseArray = {
		...
		public static double[][][] StandardIsocraticDataArray = {
			{{0.05, -0.504479647503}, {0.1, -0.71978763502}, {0.2, -0.887270972979}, {0.3, -0.923524647328}, {0.4, -0.943671664479}},
			{{0.05, -0.074953187467}, {0.1, -0.327606890135}, {0.2, -0.534050359317}, {0.3, -0.640978057358}, {0.4, -0.703420541817}, {0.5, -0.756156956677}},
			{{0.05, 0.552810022321}, {0.1, 0.209784238215}, {0.2, -0.191789296489}, {0.3, -0.388599982418}, {0.4, -0.494435112638}, {0.5, -0.554052265257}, {0.6, -0.5845892226}},
			{{0.05, 0.824299892982}, {0.1, 0.512645415012}, {0.2, 0.059030101612}, {0.3, -0.220950518723}, {0.4, -0.39454024608}, {0.5, -0.502675359192}, {0.6, -0.573794272097}},
			{{0.05, 1.0372784699}, {0.1, 0.695585615816}, {0.2, 0.229438921893}, {0.3, -0.060077862401}, {0.4, -0.24795481754}, {0.5, -0.369294827223}, {0.6, -0.456745495348}},
			{{0.05, 1.390893550432}, {0.1, 1.023026837455}, {0.2, 0.522999991273}, {0.3, 0.194919206205}, {0.4, -0.035947547188}, {0.5, -0.202543594421}, {0.6, -0.324405744155}, {0.7, -0.464322412932}, {0.8, -0.558068004271}},
			{{0.05, 1.836178801447}, {0.1, 1.429837050234}, {0.2, 0.868064342662}, {0.3, 0.481949779241}, {0.4, 0.19639526556}, {0.5, -0.020794665256}, {0.6, -0.187524513818}, {0.7, -0.359587062412}, {0.8, -0.475064312532}},
			{{0.1, 1.931153568018}, {0.2, 1.284369985648}, {0.3, 0.815272421429}, {0.4, 0.457947460418}, {0.5, 0.184654565279}, {0.6, -0.028003437904}, {0.7, -0.226010139732}, {0.8, -0.375031470071}, {0.9, -0.462566652314}, {0.95, -0.525797443711}},
			{{0.2, 1.720770961494}, {0.3, 1.160865421933}, {0.4, 0.727563367882}, {0.5, 0.39590477957}, {0.6, 0.139576643332}, {0.7, -0.090741750119}, {0.8, -0.265936394389}, {0.9, -0.394766555397}, {0.95, -0.466483442495}},
			{{0.3, 1.513564989353}, {0.4, 1.002960211778}, {0.5, 0.614020185354}, {0.6, 0.315576211375}, {0.7, 0.061016930896}, {0.8, -0.140652019496}, {0.9, -0.291028742599}, {0.95, -0.383603747726}},
			{{0.3, 1.869588806892}, {0.4, 1.283380015072}, {0.5, 0.839094247098}, {0.6, 0.499783096432}, {0.7, 0.217192913744}, {0.8, -0.014678015456}, {0.9, -0.189601618264}, {0.95, -0.277715062112}},
			{{0.4, 1.564169109112}, {0.5, 1.066979018081}, {0.6, 0.689304980819}, {0.7, 0.378655389437}, {0.8, 0.117232661621}, {0.9, -0.097472449282}, {0.95, -0.197889070781}},
			{{0.4, 1.845000511794}, {0.5, 1.297689470175}, {0.6, 0.883896882213}, {0.7, 0.545759004885}, {0.8, 0.257909445732}, {0.9, 0.012557007707}, {0.95, -0.10350488659}},
			{{0.4, 2.126282065801}, {0.5, 1.530980968031}, {0.6, 1.081341017601}, {0.7, 0.716676180619}, {0.8, 0.403267927843}, {0.9, 0.126668343957}, {0.95, -0.004666867193}},
			{{0.5, 1.765358862859}, {0.6, 1.28168820233}, {0.7, 0.890484249006}, {0.8, 0.551948844749}, {0.9, 0.244374258226}, {0.95, 0.098577883774}},
			{{0.5, 1.999243556402}, {0.6, 1.48302951634}, {0.7, 1.066333196789}, {0.8, 0.703445384243}, {0.9, 0.36542660485}, {0.95, 0.203725243345}},
			{{0.6, 1.686819635229}, {0.7, 1.245146708233}, {0.8, 0.856775030595}, {0.9, 0.48973893079}, {0.95, 0.311486587572}},
			{{0.6, 1.8904478665}, {0.7, 1.423661247647}, {0.8, 1.01210687552}, {0.9, 0.615707735017}, {0.95, 0.420973298581}},
			{{0.6, 2.095989623724}, {0.7, 1.604158614744}, {0.8, 1.168591828227}, {0.9, 0.743485414346}, {0.95, 0.532046493917}},
			{{0.7, 1.785468686316}, {0.8, 1.326341165753}, {0.9, 0.872756909849}, {0.95, 0.644691556242}},
		};
		...
		public static double[][][] TestCompoundsIsocraticDataArray = {
			{{0.05, 1.100137232067}, {0.1, 0.476790615585}, {0.2, -0.312083128052}, {0.3, -0.585649594257}, {0.4, -0.766501412366}, {0.5, -0.89526464948}, {0.6, -0.998107646322}},
			{{0.05, 1.015963087368}, {0.1, 0.628272262627}, {0.2, 0.12808878243}, {0.3, -0.157607853362}, {0.4, -0.32492126767}, {0.5, -0.424092727274}, {0.6, -0.483617641748}},
			{{0.05, 1.006672928375}, {0.1, 0.765321462164}, {0.2, 0.514023500032}, {0.3, 0.38222965502}, {0.4, 0.280633289082}, {0.5, 0.183547141435}, {0.6, 0.077597961458}, {0.7, -0.059851537101}, {0.8, -0.196134013476}},
			{{0.05, 1.706937075376}, {0.1, 1.251871461314}, {0.2, 0.631404911333}, {0.3, 0.237843354907}, {0.4, -0.024086241473}, {0.5, -0.211629584435}, {0.6, -0.345314943582}, {0.7, -0.500320066203}, {0.8, -0.591871340426}},
			{{0.1, 1.723555002103}, {0.2, 0.985181155976}, {0.3, 0.44773567871}, {0.4, 0.089091384249}, {0.5, -0.147710166688}, {0.6, -0.307911566294}, {0.7, -0.469285832463}, {0.8, -0.566275388345}},
			{{0.05, 2.046851351735}, {0.1, 1.693451880115}, {0.2, 1.034343480866}, {0.3, 0.522662893148}, {0.4, 0.161965599877}, {0.5, -0.098322354031}, {0.6, -0.285384763385}, {0.7, -0.48452579902}},
			{{0.1, 2.004203551079}, {0.2, 1.040588771582}, {0.3, 0.441338902542}, {0.4, 0.062123307101}, {0.5, -0.185787008027}, {0.6, -0.365958567399}, {0.7, -0.545482224961}, {0.8, -0.671199084866}},
			{{0.2, 1.218893762754}, {0.3, 0.474957890436}, {0.4, 0.034392965156}, {0.5, -0.229434872315}, {0.6, -0.394633781314}, {0.7, -0.549466605953}, {0.8, -0.630926747252}},
			{{0.2, 1.247974245077}, {0.3, 0.490577847169}, {0.4, 0.045000413316}, {0.5, -0.214392867237}, {0.6, -0.364639190743}, {0.7, -0.50571509809}, {0.8, -0.566275388345}},
			{{0.2, 1.278087511988}, {0.3, 0.527973953557}, {0.4, 0.083647510271}, {0.5, -0.184060188727}, {0.6, -0.350384586541}, {0.7, -0.511177993791}, {0.8, -0.587499211401}},
			{{0.2, 1.544082892617}, {0.3, 0.918004273382}, {0.4, 0.354105173788}, {0.5, -0.142980960444}, {0.6, -0.578295513734}},
			{{0.2, 1.674655630033}, {0.3, 1.284031182753}, {0.4, 0.948007226031}, {0.5, 0.655587421163}, {0.6, 0.40321795796}, {0.7, 0.169451991574}, {0.8, -0.038590172861}},
			{{0.3, 1.875010907489}, {0.4, 1.106716749765}, {0.5, 0.573956058708}, {0.6, 0.193440563797}, {0.7, -0.113604633079}},
			{{0.3, 2.158654620959}, {0.4, 1.312904286879}, {0.5, 0.605011041065}, {0.6, 0.026128088261}, {0.7, -0.541534066116}},
			{{0.4, 1.303816095604}, {0.5, 0.88155508893}, {0.6, 0.542439438135}, {0.7, 0.250477108333}, {0.8, -0.002066730831}},
			{{0.5, 1.890863587912}, {0.6, 1.401121999689}, {0.7, 0.994772949417}, {0.8, 0.629479112899}, {0.9, 0.268355023952}},
		};
