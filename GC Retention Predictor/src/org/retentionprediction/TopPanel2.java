...
public class TopPanel2 extends JPanel implements TableModelListener, Scrollable, ComponentListener
{
	...
	private JPanel getJpanelStep4() {
		if (jpanelStep4 == null) {
			...
			jpanelStep4.setBorder(BorderFactory.createTitledBorder(null, "Step #4: Back-Calculate Gradient and Flow Profiles", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, new Font("Dialog", Font.BOLD, 12), new Color(51, 51, 51)));
...
*/
	...
	private JPanel getJpanelStep5() {
		if (jpanelStep5 == null) {
			...
			jpanelStep5.setBorder(BorderFactory.createTitledBorder(null, "Step #5: Check System Suitability", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, new Font("Dialog", Font.BOLD, 12), new Color(51, 51, 51)));
