...
public class Main extends Application 
{
	...
	public void start(Stage primaryStage) {
		...
		PeakFinderGCFX peakFinderGC = new PeakFinderGCFX(primaryStage, StationaryPhaseArray, true);
		peakFinderGC.setStandardCompoundMZData(AlkaneMZArray);
		peakFinderGC.setStandardCompoundNames(AlkaneNameArray);
		peakFinderGC.setIsothermalData(AlkaneParamArray);
		peakFinderGC.run();		
