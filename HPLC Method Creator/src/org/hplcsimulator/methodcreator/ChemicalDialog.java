...
public class ChemicalDialog extends JDialog implements ActionListener, KeyListener, FocusListener, ChangeListener{
	...
	public void setCustomCompoundProperties(Compound compound)
	{
		...
		/*this.jtxtSlope1.setText(Float.toString((float)compound.dLogkwvsTSlope[0]));    	
		this.jtxtSlope2.setText(Float.toString((float)compound.dSvsTSlope[0]));    	
		this.jtxtSlope11.setText(Float.toString((float)compound.dLogkwvsTSlope[1]));    	
		this.jtxtSlope21.setText(Float.toString((float)compound.dSvsTSlope[1]));    	
		this.jtxtIntercept1.setText(Float.toString((float)compound.dLogkwvsTIntercept[0]));    	
		this.jtxtIntercept2.setText(Float.toString((float)compound.dSvsTIntercept[0]));    	
		this.jtxtIntercept11.setText(Float.toString((float)compound.dLogkwvsTIntercept[1]));    	
		this.jtxtIntercept21.setText(Float.toString((float)compound.dSvsTIntercept[1]));*/
		performValidations();
	}
	...
	public void setCompoundConcentration(double dConcentration)
	{
		...
		this.jtxtConcentration2.setText(Float.toString((float)dConcentration));
	}
	...
	private void setCompoundVariables()
	{
		...
		{
			// TODO: handle log k vs. phi relationships
	...
	private JTextField getJtxtIntercept1() {
		if (jtxtIntercept1 == null) {
			...
			jtxtIntercept1.setText("2.738254");
	...
	private JTextField getJtxtIntercept2() {
		if (jtxtIntercept2 == null) {
			...
			jtxtIntercept2.setText("-3.39349");
	...
	private JTextField getJtxtNumMatrixCompounds() {
		if (jtxtNumMatrixCompounds == null) {
			...
			jtxtNumMatrixCompounds.setText("50");
		}
	...
	private JTextField getJtxtMaximumConcentration() {
		if (jtxtMaximumConcentration == null) {
			...
			jtxtMaximumConcentration.setText("1000");
		}
	...
	private JTextField getJtxtMinimumConcentration() {
		if (jtxtMinimumConcentration == null) {
			...
			jtxtMinimumConcentration.setText(".01");
		}
	...
	private JTextField getJtxtIntercept21() {
		if (jtxtIntercept21 == null) {
			...
			jtxtIntercept21.setText("-3.547073");
		}
	...
	private JTextField getJtxtIntercept11() {
		if (jtxtIntercept11 == null) {
			...
			jtxtIntercept11.setText("3.230992");
		}
	...
	public void validateConcentration2()
	{
		if (jtxtConcentration2.getText().length() == 0)
			jtxtConcentration2.setText("0");

    	double dTemp = (double)Float.valueOf(jtxtConcentration2.getText());
		...
		this.m_dConcentration2 = dTemp;
		jtxtConcentration2.setText(Float.toString((float)m_dConcentration2));    	
	}
	
	public void validateSlope1()
	{
		if (jtxtSlope1.getText().length() == 0)
			jtxtSlope1.setText("0");

    	double dTemp = (double)Float.valueOf(jtxtSlope1.getText());
		...
		this.m_dLogkwvsTSlope[0] = dTemp;
		jtxtSlope1.setText(Float.toString((float)m_dLogkwvsTSlope[0]));    	
	}
	
	public void validateSlope2()
	{
		if (jtxtSlope2.getText().length() == 0)
			jtxtSlope2.setText("0");

    	double dTemp = (double)Float.valueOf(jtxtSlope2.getText());
		...
		this.m_dSvsTSlope[0] = dTemp;
		jtxtSlope2.setText(Float.toString((float)m_dSvsTSlope[0]));    	
	}
	
	public void validateSlope11()
	{
		if (jtxtSlope11.getText().length() == 0)
			jtxtSlope11.setText("0");

    	double dTemp = (double)Float.valueOf(jtxtSlope11.getText());
		...
		this.m_dLogkwvsTSlope[1] = dTemp;
		jtxtSlope11.setText(Float.toString((float)m_dLogkwvsTSlope[1]));    	
	}
	
	public void validateSlope21()
	{
		if (jtxtSlope21.getText().length() == 0)
			jtxtSlope21.setText("0");

    	double dTemp = (double)Float.valueOf(jtxtSlope21.getText());
		...
		this.m_dSvsTSlope[1] = dTemp;
		jtxtSlope21.setText(Float.toString((float)m_dSvsTSlope[1]));    	
	}
	
	public void validateIntercept1()
	{
		if (jtxtIntercept1.getText().length() == 0)
			jtxtIntercept1.setText("0");

    	double dTemp = (double)Float.valueOf(jtxtIntercept1.getText());
		...
		this.m_dLogkwvsTIntercept[0] = dTemp;
		jtxtIntercept1.setText(Float.toString((float)m_dLogkwvsTIntercept[0]));    	
	}
	
	public void validateIntercept2()
	{
		if (jtxtIntercept2.getText().length() == 0)
			jtxtIntercept2.setText("0");

    	double dTemp = (double)Float.valueOf(jtxtIntercept2.getText());
		...
		this.m_dSvsTIntercept[0] = dTemp;
		jtxtIntercept2.setText(Float.toString((float)m_dSvsTIntercept[0]));    	
	}
	
	public void validateIntercept11()
	{
		if (jtxtIntercept11.getText().length() == 0)
			jtxtIntercept11.setText("0");

    	double dTemp = (double)Float.valueOf(jtxtIntercept11.getText());
		...
		this.m_dLogkwvsTIntercept[1] = dTemp;
		jtxtIntercept11.setText(Float.toString((float)m_dLogkwvsTIntercept[1]));    	
	}
	
	public void validateIntercept21()
	{
		if (jtxtIntercept21.getText().length() == 0)
			jtxtIntercept21.setText("0");

    	double dTemp = (double)Float.valueOf(jtxtIntercept21.getText());
		...
		this.m_dSvsTIntercept[1] = dTemp;
		jtxtIntercept21.setText(Float.toString((float)m_dSvsTIntercept[1]));    	
	}
	
	public void validateNumMatrixCompounds()
	{
		if (jtxtNumMatrixCompounds.getText().length() == 0)
			jtxtNumMatrixCompounds.setText("0");

    	int iTemp = (int)Integer.valueOf(jtxtNumMatrixCompounds.getText());
		...
		this.m_iNumMatrixCompounds = iTemp;
		jtxtNumMatrixCompounds.setText(Integer.toString((int)m_iNumMatrixCompounds));    	
	}
	
	public void validateMinConcentration()
	{
		if (jtxtMinimumConcentration.getText().length() == 0)
			jtxtMinimumConcentration.setText("0");

    	double dTemp = (double)Float.valueOf(jtxtMinimumConcentration.getText());
		
		if (dTemp < .000001)
			dTemp = .000001;
		if (dTemp > 100000)
			dTemp = 100000;
		if (dTemp > this.m_dMaximumConcentration)
			dTemp = this.m_dMaximumConcentration;
		
		this.m_dMinimumConcentration = dTemp;
		jtxtMinimumConcentration.setText(Float.toString((float)m_dMinimumConcentration));    	
	}

	public void validateMaxConcentration()
	{
		if (jtxtMaximumConcentration.getText().length() == 0)
			jtxtMaximumConcentration.setText("0");

    	double dTemp = (double)Float.valueOf(jtxtMaximumConcentration.getText());
		
		if (dTemp < .000001)
			dTemp = .000001;
		if (dTemp > 100000)
			dTemp = 100000;
		if (dTemp < this.m_dMinimumConcentration)
			dTemp = this.m_dMinimumConcentration;
		
		this.m_dMaximumConcentration = dTemp;
		jtxtMaximumConcentration.setText(Float.toString((float)m_dMaximumConcentration));    	
	}
