...
public class GeneralProperties extends JXPanel {
	...
	private void initialize() {
        ...
        jlblFinalTime2.setLocation(new Point(196, 176));
        ...
        jlblNoise2.setText("");
        jlblNoise2.setLocation(new Point(196, 104));
        ...
        jlblSignalOffset2.setLocation(new Point(196, 80));
        ...
        jlblTimeConstant2.setLocation(new Point(196, 56));
        ...
        jlblDiffusionCoefficient3.setLocation(new Point(196, 32));
        ...
        jlblDiffusionCoefficient.setLocation(new Point(136, 32));
        ...
        jlblDiffusionCoefficient2.setLocation(new Point(8, 32));
        ...
        this.setLayout(null);
        this.setSize(new Dimension(254, 225));
	...
	private JCheckBox getJchkAutoTimeRange() {
		if (jchkAutoTimeRange == null) {
			...
			jchkAutoTimeRange.setBounds(new Rectangle(8, 124, 243, 24));
	...
	private JTextField getJtxtTimeConstant() {
		if (jtxtTimeConstant == null) {
			...
			jtxtTimeConstant.setBounds(new Rectangle(136, 52, 57, 26));
		}
	...
	private JTextField getJtxtSignalOffset() {
		if (jtxtSignalOffset == null) {
			...
			jtxtSignalOffset.setBounds(new Rectangle(136, 76, 57, 26));
		}
	...
	private JTextField getJtxtNoise() {
		if (jtxtNoise == null) {
			...
			jtxtNoise.setText("2");
			jtxtNoise.setBounds(new Rectangle(136, 100, 57, 26));
		}
		return jtxtNoise;
	}
	...
	private JTextField getJtxtInitialTime() {
		if (jtxtInitialTime == null) {
			...
			jtxtInitialTime.setBounds(new Rectangle(136, 148, 57, 26));
	...
	private JTextField getJtxtFinalTime() {
		if (jtxtFinalTime == null) {
			...
			jtxtFinalTime.setBounds(new Rectangle(136, 172, 57, 26));
	...
	private JTextField getJtxtNumPoints() {
		if (jtxtNumPoints == null) {
			...
			jtxtNumPoints.setBounds(new Rectangle(136, 196, 57, 26));
		}
