...
import org.hplcsimulator.methodcreator.Globals;
...
public class MobilePhaseComposition extends JXPanel 
{
	...
	private void initialize() {
        ...
        this.setLayout(null);
        this.setSize(new Dimension(254, 118));
	...
	private JRadioButton getJrdoIsocraticElution() {
		if (jrdoIsocraticElution == null) {
			...
			jrdoIsocraticElution.setBounds(new Rectangle(8, 68, 233, 17));
	...
	private JRadioButton getJrdoGradientElution() {
		if (jrdoGradientElution == null) {
			...
			jrdoGradientElution.setBounds(new Rectangle(8, 92, 233, 17));
