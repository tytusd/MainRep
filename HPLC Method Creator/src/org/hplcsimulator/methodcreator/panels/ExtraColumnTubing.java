...
public class ExtraColumnTubing extends JXPanel 
{
	...
	private void initialize() {
        ...
        jlblDispersionUnits.setBounds(new Rectangle(196, 104, 45, 16));
        ...
        jlblDispersion.setBounds(new Rectangle(136, 104, 57, 16));
        ...
        jlblColumnDiameter2.setLocation(new Point(196, 56));
        ...
        jlblColumnLength2.setLocation(new Point(196, 32));
        ...
        jlblColumnDiameter.setLocation(new Point(28, 56));
        jlblColumnLength = new JLabel();
        jlblColumnLength.setText("Length:");
        jlblColumnLength.setSize(new Dimension(105, 16));
        jlblColumnLength.setLocation(new Point(28, 32));
        this.setLayout(null);
        this.setSize(new Dimension(254, 126));
	...
	private JTextField getJtxtTubingLength() {
		if (jtxtTubingLength == null) {
			...
			jtxtTubingLength.setBounds(new Rectangle(136, 28, 57, 26));
		}
	...
	private JTextField getJtxtTubingDiameter() {
		if (jtxtTubingDiameter == null) {
			...
			jtxtTubingDiameter.setBounds(new Rectangle(136, 52, 57, 26));
		}
