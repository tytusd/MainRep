...
public class PlotOptions extends JXPanel 
{
	...
	public JRadioButton jrdoNumberOfCompounds = null;
	...
	private void initialize() {
        ...
        this.setPreferredSize(new Dimension(254, 248));
        ...
        jrdoNumberOfCompounds = new JRadioButton();
        jrdoNumberOfCompounds.setText("Number of compounds eluting");
        jrdoNumberOfCompounds.setBounds(new Rectangle(8, 100, 201, 17));
        jrdoNumberOfCompounds.setActionCommand("Plot number of compounds eluting");
        jrdoNumberOfCompounds.setBounds(8, 220, 201, 17);
        add(jrdoNumberOfCompounds);
