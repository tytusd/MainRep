package org.hplcsimulator.methodcreator.panels;
...
public class ChromatographyProperties extends JXPanel 
{
	...
	private void initialize() {
        ...
        jlblLabel.setBounds(new Rectangle(8, 120, 125, 16));
        jlblLabel.setText("Flow velocity:");
        jlblChromatographicVelocityUnits = new JLabel();
        jlblChromatographicVelocityUnits.setBounds(new Rectangle(196, 192, 49, 16));
        ...
        jlblChromatographicVelocity.setBounds(new Rectangle(136, 192, 57, 16));
        ...
        jlblChromatographicVelocity2.setBounds(new Rectangle(28, 192, 105, 16));
        jlblChromatographicVelocity2.setText("Chromatographic:");
        jlblReducedVelocity = new JLabel();
        jlblReducedVelocity.setBounds(new Rectangle(136, 216, 57, 16));
        ...
        jlblReducedVelocity2.setBounds(new Rectangle(28, 216, 105, 16));
        jlblReducedVelocity2.setText("Reduced:");
        jlblInterstitialVelocityUnits = new JLabel();
        jlblInterstitialVelocityUnits.setBounds(new Rectangle(196, 168, 49, 16));
        ...
        jlblInterstitialVelocity.setBounds(new Rectangle(136, 168, 57, 16));
        ...
        jlblInterstitialVelocity2.setBounds(new Rectangle(28, 168, 105, 16));
        jlblInterstitialVelocity2.setText("Interstitial:");
        jlblBackpressure3 = new JLabel();
        jlblBackpressure3.setText("bar");
        jlblBackpressure3.setLocation(new Point(196, 288));
        ...
        jlblBackpressure.setLocation(new Point(136, 288));
        ...
        jlblBackpressure2.setLocation(new Point(8, 288));
        jlblTheoreticalPlates = new JLabel();
        jlblTheoreticalPlates.setText("19000");
        jlblTheoreticalPlates.setLocation(new Point(136, 264));
        ...
        jlblHETP2.setLocation(new Point(8, 240));
        jlblOpenTubeVelocity3 = new JLabel();
        jlblOpenTubeVelocity3.setText("cm/s");
        jlblOpenTubeVelocity3.setLocation(new Point(196, 144));
        ...
        jlblOpenTubeVelocity.setLocation(new Point(136, 144));
        ...
        jlblFlowRate.setLocation(new Point(8, 96));
        ...
        jlblTemperature.setEnabled(false);
        this.setLayout(null);
        this.setSize(new Dimension(254, 310));
        this.setPreferredSize(this.getSize());
        this.add(jlblTemperature, null);
        this.add(getJsliderTemp(), null);
        this.jsliderTemp.setEnabled(false);
        this.add(getJtxtTemp(), null);
        this.jtxtTemp.setEnabled(false);
	...
	private JTextField getJtxtTemp() {
		if (jtxtTemp == null) {
			...
			jtxtTemp.setBounds(new Rectangle(200, 20, 45, 26));
	...
	private JTextField getJtxtInjectionVolume() {
		if (jtxtInjectionVolume == null) {
			...
			jtxtInjectionVolume.setBounds(new Rectangle(136, 68, 57, 26));
		}
	...
	private JTextField getJtxtFlowRate() {
		if (jtxtFlowRate == null) {
			...
			jtxtFlowRate.setBounds(new Rectangle(136, 92, 57, 26));
		}
		return jtxtFlowRate;
	}
