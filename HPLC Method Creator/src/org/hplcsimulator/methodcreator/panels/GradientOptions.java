...
public class GradientOptions extends JXPanel 
{
	...
	private void initialize() {
        ...
        jlblDwellTimeUnit.setBounds(new Rectangle(196, 220, 50, 16));
        ...
        jlblDwellVolumeIndicator.setBounds(new Rectangle(128, 196, 65, 16));
        ...
        jlblDwellVolume.setBounds(new Rectangle(8, 196, 117, 16));
        jlblDwellVolume.setText("Total dwell volume:");
        jlblMixingVolumeUnit = new JLabel();
        jlblMixingVolumeUnit.setBounds(new Rectangle(196, 148, 50, 16));
        ...
        jlblMixingVolume.setBounds(new Rectangle(24, 148, 101, 16));
        jlblMixingVolume.setText("Mixing:");
        jlblNonMixingVolumeUnit = new JLabel();
        jlblNonMixingVolumeUnit.setBounds(new Rectangle(196, 172, 50, 16));
        ...
        jlblNonMixingVolume.setBounds(new Rectangle(24, 172, 101, 16));
        jlblNonMixingVolume.setText("Non-mixing:");
        this.setLayout(null);
        this.setSize(new Dimension(254, 245));
	...
	private JTextField getJtxtNonMixingVolume() {
		if (jtxtNonMixingVolume == null) {
			...
			jtxtNonMixingVolume.setBounds(new Rectangle(128, 168, 65, 26));
	...
	private JTextField getJtxtMixingVolume() {
		if (jtxtMixingVolume == null) {
			...
			jtxtMixingVolume.setBounds(new Rectangle(128, 144, 65, 26));
