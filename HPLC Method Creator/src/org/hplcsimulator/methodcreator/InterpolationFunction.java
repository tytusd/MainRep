...
class InterpolationFunction
{
	...
	public double[][] dFirstTwoDataPoints = new double[2][2];
	public double[][] dLastTwoDataPoints = new double[2][2];
	...
	public InterpolationFunction(double[][] dataPoints)
	{
		...
		// Put in first two and last two data points
		dFirstTwoDataPoints[0][0] = dataPoints[0][0];
		dFirstTwoDataPoints[0][1] = dataPoints[0][1];
		dFirstTwoDataPoints[1][0] = dataPoints[1][0];
		dFirstTwoDataPoints[1][1] = dataPoints[1][1];
		
		dLastTwoDataPoints[0][0] = dataPoints[dataPoints.length - 2][0];
		dLastTwoDataPoints[0][1] = dataPoints[dataPoints.length - 2][1];
		dLastTwoDataPoints[1][0] = dataPoints[dataPoints.length - 1][0];
		dLastTwoDataPoints[1][1] = dataPoints[dataPoints.length - 1][1];
	...
	public double getAt(double x)
	{
		...
		if (x < dFirstTwoDataPoints[0][0])
			return extrapolateBefore(x);
		else if (x > dLastTwoDataPoints[1][0])
	...
	{
		// Find slope
		double dSlope = (dFirstTwoDataPoints[1][1] - dFirstTwoDataPoints[0][1]) / (dFirstTwoDataPoints[1][0] - dFirstTwoDataPoints[0][0]);
		double dIntercept = dFirstTwoDataPoints[0][1] - (dSlope * dFirstTwoDataPoints[0][0]);
	...
	{
		// Find slope
		double dSlope = (dLastTwoDataPoints[1][1] - dLastTwoDataPoints[0][1]) / (dLastTwoDataPoints[1][0] - dLastTwoDataPoints[0][0]);
		double dIntercept = dLastTwoDataPoints[1][1] - (dSlope * dLastTwoDataPoints[1][0]);
